...
A professional Streamlit dashboard for market regime-aware stock classification framework using S&P 500 stocks from the [Kaggle dataset](https://www.kaggle.com/datasets/innacampo/s-and-p-500-stocks-daily-historical-data-10-years), featuring multi-stock comparison and price trend analysis.
